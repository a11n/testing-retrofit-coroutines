package de.ad.retrofitwithcoroutines.util
...
//Copied from https://github.com/gildor/kotlin-coroutines-retrofit/blob/master/src/test/kotlin/ru/gildor/coroutines/retrofit/util/MockedCall.kt
class MockedCall<T>(
